...
@else
    ...
    <body>
    <img class="wave" src="/assets/login_img/wave.png">
    <div class="container">
        <div class="img">
            <img src="/assets/login_img/bg.svg">
        </div>
        <div class="login-content">
            <form action="{{ route('admin.giris') }}" method="post">
                {{ csrf_field() }}
                <img src="/assets/login_img/avatar.svg">
    ...
    <script type="text/javascript" src="/assets/login_js/main.js"></script>
    </body>
    </html>
@endif
